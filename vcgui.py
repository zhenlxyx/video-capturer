...
if currentHour >= 19 or currentHour <= 7:
    ...
    fileLb.configure(background="#383838", highlightbackground="#ffffff", foreground="#ffffff", highlightthickness=1)
    ...
    fileLb.configure(background="#ffffff", highlightbackground="#1F1C19", foreground="#1F1C19", highlightthickness=1)
